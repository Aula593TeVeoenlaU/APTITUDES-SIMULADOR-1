...
{ id: 20, block: 'BIOLOGÍA', text: 'Durante el metabolismo energético, ¿cuál de los siguientes procesos permite a la célula obtener la mayor cantidad de ATP a partir de una molécula de glucosa?', options: ['a) La glucólisis en el citoplasma.', 'b) La variación genética dentro de una especie.', 'c) LLa fermentación láctica en condiciones de baja disponibilidad de oxígeno.', 'd) El ciclo de Calvin durante la fotosíntesis.'], answer: 'c' },
   ...
   { id: 28, block: 'ANATOMÍA', text: '¿Cuál de los siguientes huesos forma parte del esqueleto axial?', options: ['a) Esternón', 'b) Húmero', 'c) Fémur', 'd) Radio'], answer: 'b' },
...
{ id: 32, block: 'ANATOMÍA', text: 'El sistema nervioso autónomo se divide en simpático y parasimpático. ¿Cuál es una característica principal de la activación del sistema parasimpático?', options: ['a) Aurícula derecha.', 'b) Ventrículo derecho', 'c) Ventrículo izquierdo', 'd) Aurícula izquierda'], answer: 'd' },
...
{ id: 40, block: 'ANATOMÍA', text: '¿En qué estructura específica del sistema digestivo ocurre la absorción de la gran mayoría de los nutrientes hacia el torrente sanguíneo?', options: ['a) Las paredes del estómago.', 'b) La mucosa del intestino grueso.', 'c) El conducto biliar.', 'd) Las vellosidades del intestino delgado.'], answer: 'b' },
